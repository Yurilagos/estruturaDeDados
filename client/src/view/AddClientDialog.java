...
public class AddClientDialog extends JDialog {
	...
	private void addClientComponents() {
		...
		panel.add(name, new GBC(0, 0).left().insets(2, 10, 10, 10));

		JLabel CPF = new JLabel("CPF");
		panel.add(CPF, new GBC(0, 1).left().insets(2, 10, 10, 10));
		
		JLabel birthday = new JLabel("Nascimento");
		panel.add(birthday, new GBC(0, 2).left().insets(2, 10, 10, 10));

		JTextField nameTextField = new JTextField(20);
		panel.add(nameTextField, new GBC(1, 0).right().insets(2, 0, 10, 10));

		JTextField CPFTextField = new JTextField(20);
		panel.add(CPFTextField, new GBC(1, 1).right().insets(2, 0, 10, 10));
		
		JTextField birthdayTextField = new JTextField(20);
		panel.add(birthdayTextField, new GBC(1, 2).right().insets(2, 0, 10, 10));
		
		JButton saveButton = new JButton("Salvar");
		panel.add(saveButton, new GBC(1, 3).right().insets(5, 10, 10, 10));
